(function (a) {
    "use strict", typeof define == "function" && define.amd ? define(["jquery", "./load-image.js", "bootstrap"], a) : a(window.jQuery, window.loadImage)
})(function (a, b) {
    ...
    a.extend(a.fn.modal.Constructor.prototype, {
        ...
        loadImage: function () {
            ...
            }, 100), e = c.find(".modal-image").children().removeClass("in"), window.setTimeout(function () {
                e.remove()
        ...
        showImage: function (b) {
            ...
            }), g && g.remove()), f.append(b), h = b.offsetWidth, a(b).addClass("in")
        },
        abortLoad: function () {
        ...
        show: function () {
            if (!this.isShown && this.$element.hasClass("modal-gallery")) {
                var b = this.$element,
                    ...
                    e = a(window).width(),
                    f = a(window).height();
                this.urls = [], this.titles = [], b.hasClass("modal-fullscreen") ? this.loadImageOptions = {
                    minWidth: e,
                    minHeight: f,
                    maxWidth: e,
                    maxHeight: f,
