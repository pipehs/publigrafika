...
$(function () {
    ...
    $('#fileupload').fileupload({
		...
		$('.saveInfo').click(function(){
			...
			$.ajax({
				type: 'POST',
				url: '/admin/vehiculos/infoGaleriaMovil',
				data: {csrf_toyota_site: tyt_sec_val, vehiculo_id: vehiculo_id, id: id, comentario: comentario},
				dataType: 'json',
...
function guardar_orden(){
	...
	$.ajax({
		type: 'POST',
		url: '/admin/vehiculos/saveOrdenGaleriaModelo',
		data: {csrf_toyota_site: tyt_sec_val, vehiculo_id: vehiculo_id, orden: orden,galeria_movil:'true'},
		dataType: 'json',
		success: function(data){
